...
// 객체 생성시 한번만 호출되는 메서드.
// 생성된 객체 내에서는 사용이 불가능
// 객체 생성시에 필요한 메모리공간 형성과 "초기값 부여"에 사용됨
...
class C08Simple {
	...
	// 기능
	// 디폴트 생성자는 클래스명과 같아야함 // 받아야될 메서드가 많으면 오버로딩 가능
	C08Simple() {
...
public class C08ConstructorMain생성자 {
	// 생성자 함수가 1개이상 있으면 디폴트생성자 생성안함. 0개이면 디폴트 생성자 생성함
	public static void main(String[] args) {
		C08Simple ob0 = new C08Simple();
		C08Simple ob1 = new C08Simple(10);
		C08Simple ob2 = new C08Simple(10, 10.10);
		C08Simple ob3 = new C08Simple(10, 20.20, false);
		C08Simple ob4 = new C08Simple(22, 77.77, true, "헤응");
