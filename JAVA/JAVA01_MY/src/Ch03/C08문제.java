...
//[예시]
//----------------------------
//byte byteValue = 10; 변화O
//char charValue = 'A'; X
//----------------------------문제있음 O 없음 X
//1) int intValue = byteValue; X
//2) int intValue = charValue; X
//3) short shortValue = charValue; O
...
//4) double result = 5 + doubleValue; 증답
//
...
//int i1 = 3;
//int i2 = 4;
//short result = s1 + s2; int형인데 short라 문제발생
//int result = i1 + i2;
//----------------------------
//
...
//char c1 = 'a';
//char c2 = c1 + 1; 
//char로 받아와서 c1은 a 즉 아스키코드 97인데 +로 연산했을때 int형으로 나와서 b가 아닌 98이 나옴
//char c2 = char(c1 + 1);로 바꾸던지 84번행에서 int형으로 바꾸면 됨
...
//double var3 = 2.5;
//String var4 = "3.9";
//int result =_______________; -> var1 + var2 + var3 + var4 -
// -> 2.0 + 1.8 _ 2.5 + 3.9 = 10.2가 나옴. 적절하게 변경
//System.out.println(result);
//----------------------------
//
//
