...
public class C01IF {
	...
	public static void main(String[] args) {
		...
		System.out.print("나이 : ");
		int age = sc.nextInt(); //age를 입력하면 if문 2개로 판단해서 거기에 맞는 값이 출력됨
		if(age >= 8)
...
//		sc.close();
		...
		//5 문제
//		입력한 수가 짝수이고, 3의 배수라면 풀력 (n%2==0 && n%3==0)
//		입력한 수가 홀수이고, 5의 배수라면 풀력 (n%2==1 && n%5==0)
