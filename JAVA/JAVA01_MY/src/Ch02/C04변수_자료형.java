...
//		// \\u : 유니코드 이스케이프문자
//		System.out.printf("%c\n", 0xac03);
//		System.out.printf("%c\n", '\uac03'); // 이스케이프 문자를 안넣으면 문자열이라고 간주함. 넣으면 단일문자
...
//		char n3 = 40;
		...
		System.out.println("UTF-8기준 지정 크리 :" + name.getBytes(StandardCharsets.UTF_8).length);
		System.out.println("UTF-8기준 지정 크리 :" + job.getBytes(StandardCharsets.UTF_8).length);
