...
public class C03변수_자료형 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
					...
					// 우측부터 계산 lv(공간) = rv(값) 인경우 rv부터 계산한후 lv에 대입
		int num1;					// int만큼 크기(4byte)의 공간형성 + num1 이름부여(변수 정의)
		num1 = 10;					// 10이라는 값(리터럴상수)을 상수 Pool에 저장, num1공간에 대입(복사)
		int num2 = 4;				// 4라고 하는 값(리터럴상수)을 상수 Pool에 저장, 4bye 정수공간 num2에 초기화
